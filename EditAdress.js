...
this.setState({city:this.props.navigation.state.params.city_state})
this.setState({landmark:this.props.navigation.state.params.landmark})
this.setState({address:this.props.navigation.state.params.address})
this.setState({zip:this.props.navigation.state.params.pincode})
GLOBAL.lat = this.props.navigation.state.params.latitude
GLOBAL.long = this.props.navigation.state.params.longitude
      ...
      alert('Please Enter Landmark')
        ...
        alert('Please Enter ZipCode')
          ...
          alert('Please Enter valid  ZipCode')
              ...
              const url = GLOBAL.BASE_URL +  'edit_address'
