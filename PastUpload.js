...
export default class PastUpload extends Component {
    state = {
        text: '',
        passwordtext :'',
        isSecure : true,
          ...
          <SafeAreaView style={styles.AndroidSafeArea}>
                         ...
                         <Image style = {{width :30 ,height: 30,marginTop:8,marginLeft:20,resizeMode: 'contain'}}
                                ...
                                <Text style = {{fontFamily:GLOBAL.semi,fontSize:18,color:"white",marginTop:10}}>
                                             ...
                                             <Text style = {{fontFamily:GLOBAL.semi,fontSize:18,color:"#1D1D26",marginTop:20,marginLeft:20}}>
