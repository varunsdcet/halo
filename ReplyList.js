...
export default class ReplyList extends Component {
  ...
  _YesDeleteComment=(item,index)=>{
          ...
          const url = GLOBAL.BASE_URL +  'delete_reply_comments'
          ...
          fetch(url, {
              ...
              body: JSON.stringify({
                  ...
                  comment_reply_id:item.comment_reply_id,
...
//EmailValidator.validate("test@email.com");
    ...
    getList = () =>{
      this.showLoading()
      const url = GLOBAL.BASE_URL +  'comments_reply_list'
      ...
      fetch(url, {
          ...
          body: JSON.stringify({
              user_id : GLOBAL.user_id,
              comment_id: this.props.navigation.state.params,
...
console.log(JSON.stringify(responseJson))
              if (responseJson.status == true) {
                  ...
                  this.setState({comment:responseJson.list})
                  //   this.setState({news:responseJson.news})
    ...
    send = () =>{
         ...
         if(this.state.texts==''){
             ...
             const url = GLOBAL.BASE_URL +  'replay_article_comments'
...
console.log(JSON.stringify(responseJson))
                     if (responseJson.status == true) {
                         ...
                         this.setState({comment:responseJson.reply_comment_list})
                         //   this.setState({news:responseJson.news})
